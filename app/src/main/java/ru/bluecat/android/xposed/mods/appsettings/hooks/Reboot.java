...
public class Reboot {
    ...
    static void grantRebootPermission(XC_MethodHook.MethodHookParam param, String pkgName) {
        try {
            ...
            if (!(Boolean) XposedHelpers.callMethod(permissionsState, "hasInstallPermission", Constants.REBOOT)) {
                Object pAccess = XposedHelpers.callMethod(mPermissions, "get", Constants.REBOOT);
    ...
    static void grantRebootPermissionS(Object param, Object pkgId) {
        try {
            ...
            Object bp = XposedHelpers.callMethod(mRegistry, "getPermission", Constants.REBOOT);
